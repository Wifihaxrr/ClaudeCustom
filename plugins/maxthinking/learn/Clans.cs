        ...
        private void CmdConsoleClans(ConsoleSystem.Arg arg)
        {
            ...
            switch (arg.Args[0])
            {
...
#if TESTING
									Puts($"Calling AllyCance46304lInvite method with player: {player}, tag: {arg.Args[2]}");
#endif
                        ...
                        switch (arg.Args[1])
                        {
                            ...
                            case "create":
                            {
                                    ...
                                    !player.HasPermission(_config.PermissionSettings.ClanCreating))
                                {
                                    ...
                                    {
#if TESTING
												Puts($"Calling Create46304ClanUi method with player: {player}");
#endif
                                        ShowClanCreationUI(player);
                                    }
                                    else
                ...
                case "setamountitem":
                {
                    ...
                    {
#if TESTING
								PrintError($"Could not parse amount from argument {arg.Args[2]}46304");
#endif
                        return;
                    }
