...
namespace Oxide.Plugins
{
    ...
    class SkinBox : ChaosPlugin
    {
        ...
        private class SprayCanWatcher : MonoBehaviour
        {
            ...
            private const int LAYER_MASK = 1 << (int)Rust.Layer.Reserved1 | 1 << (int) Rust.Layer.Construction | 1 << (int) Rust.Layer.Deployed | 1 << (int)Rust.Layer.Physics_Debris; //6036
            private void Awake()
            {
