...
{
	[Info("Death Notes", "Terceran/Mr. Blue", "6.5.2")]
	...
	class DeathNotes : RustPlugin
	{
		...
		private void OnEntityDeath(BaseCombatEntity victimEntity, HitInfo hitInfo)
		{
			...
			// or ones where a player trap, SAM site, Drone, or trap caused a death.
/*			if (data.VictimEntityType != CombatEntityType.Player && data.KillerEntityType != CombatEntityType.Player &&
				...
				data.KillerEntityType != CombatEntityType.Scientist && data.KillerEntityType != CombatEntityType.Drone &&
				data.KillerEntityType != CombatEntityType.HeavyScientist && data.DamageType != DamageType.Drowned)
				return;*/
			...
			if (
					...
					((data.KillerEntityType == CombatEntityType.Turret || data.KillerEntityType == CombatEntityType.Trap || data.KillerEntityType == CombatEntityType.SAM ||
					  data.KillerEntityType == CombatEntityType.Drone || data.KillerEntityType == CombatEntityType.Scientist ||
					  data.KillerEntityType == CombatEntityType.HeavyScientist || data.DamageType == DamageType.Drowned) &&
		...
		private string PopulateMessageVariables(string message, DeathData data)
		{
			...
			if (data.KillerEntityType != CombatEntityType.None)
			{
				...
				if ((data.KillerEntityType == CombatEntityType.Player) || (data.KillerEntityType == CombatEntityType.Drone))
				{
