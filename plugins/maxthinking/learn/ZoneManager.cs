...
namespace Oxide.Plugins
{
    ...
    {
        #region Fields
        [PluginReference] Plugin Backpacks, PopupNotifications, Spawns, RaidableBases;
        ...
        private object OnEntityTakeDamage(BaseCombatEntity entity, HitInfo hitinfo)
        {
            ...
            // Allow damage to RaidableBases entities - let RaidableBases handle its own protection
